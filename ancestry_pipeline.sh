...
#Give path of Manufacturer SNP ID to rs-id conversion table.Illumina/Affy provide these 
#UK Biobank Array snplist already provided

#For Illumina: Go to the kit support page for the array, click downloads, then click ArrayNameHere support files
